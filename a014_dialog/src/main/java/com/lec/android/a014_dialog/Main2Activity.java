        ...
        switch (id) {
            ...
            case DIALOG_RADIO:
                ...
                builder3.setTitle("색을 고르세요")
                        .setPositiveButton("버튼선택완료", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                        ...
                        .setSingleChoiceItems(
                                ...
                                , -1 // 기본 설정값
                                , new DialogInterface.OnClickListener() {
                                    // 라디오 버튼에서 선택했을 때 호출되는 콜백, which : 몇번째 선택
                                    @Override
                                    public void onClick(DialogInterface dialog, int which) {
                                        choice = which;
                                    }
            ...
            case DIALOG_MULTICHOICE:
                ...
                final String[] data = {"한국", "북학", "러시아", " 영국"};
