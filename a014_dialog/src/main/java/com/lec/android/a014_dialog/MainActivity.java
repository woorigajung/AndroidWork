...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dlg1.setContentView(R.layout.dialog_layout11);  // 다이얼고그 화면 등록
        ...
        dlg1.setCanceledOnTouchOutside(true);   // 다이얼로그 바깥 영역 클릭시 (혹은 back qjxms zmfflrtl) hide() 상태가 됨.
        ...
        etName = dlg2.findViewById(R.id.etName);
