 ...
 * <p>
 * res -> 우클릭 -> new -> Android Resource Directory -> Resource Type raw 선택
 */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            sp = new SoundPool(1,   // 재생 음향 최대 개수
                    ...
                    0                 // 재생 품질 (안쓰임, 디폴트 0 이라는 것만 알기)
            );
        }

        // SoundPool 에 음퍙 리소스들을 Load
        ...
        btnPlay1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                sp.play(soundId[0],   // 준비한 sound 리소스 id
                        ...
                        2f);      // 재생속도 float, 0.5(절반속도) ~ 2.0(두배속)
            }
        });
        ...
        btnPlay2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                sp.play(soundId[1],   // 준비한 sound 리소스 id
                        ...
                        1f);      // 재생속도 float, 0.5(절반속도) ~ 2.0(두배속)
            }
        });
        ...
        btnPlay3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                sp.play(soundId[2],   // 준비한 sound 리소스 id
                        ...
                        0.5f);      // 재생속도 float, 0.5(절ㄹ반속도) ~ 2.0(두배속)
            }
        });
