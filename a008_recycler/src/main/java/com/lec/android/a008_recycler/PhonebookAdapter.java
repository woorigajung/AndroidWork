...
public class PhonebookAdapter extends RecyclerView.Adapter<PhonebookAdapter.ViewHolder> {
    ...
    List<Phonebook> itmes = new ArrayList<Phonebook>();
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        Phonebook item = itmes.get(position);
        holder.setItem(item);
    }
        ...
        public ViewHolder(@NonNull View itemView) { // item 레이아웃의 View 객체가 전달됨.
            ...
            btnDelItem.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    // 데이터 변경 내역이 adapter에 반영 되어야 정상적으로 동작함!! ★
    ...
    public void addItem(Phonebook item) {  itmes.add(item); }
    public void addItem(int position, Phonebook item) {   itmes.add(position, item);}
    public void setItems(ArrayList<Phonebook> items) {   this.itmes  = items;}
    public Phonebook getItem(int position) {   return itmes.get(position);}
    public void setItem(int position, Phonebook item) {  itmes.set(position, item);   }
    public void removeItem(int position){ itmes.remove(position); }
