...
public class Main3Activity extends AppCompatActivity {
    ...
    void update() {
        db.execSQL("UPDATE mytable SET name = '하혜진' WHERE id = 2");
    ...
    void insert() {
        db.execSQL("INSERT INTO mytable (name) values('정종훈')");
        db.execSQL("INSERT INTO mytable (name) values('야')");
        db.execSQL("INSERT INTO mytable (name) values('나두')");
